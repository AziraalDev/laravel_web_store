...
class ProductFactory extends Factory
{
    public function definition(): array
    {
        ...
        return [
            'title' => $title,
            'slug' => $slug,
            'SKU' => fake()->unique()->ean13(), // unique BAR CODEs
            'description' => fake()->boolean() ? fake()->sentences(rand(2,6), true) : null,
            'price' => fake()->randomFloat(2, 10, 40),
            'discount' => fake()->boolean() ? rand(5, 25) : 0, // discount from 5 to 25 %
            'quantity' => rand(0, 35),
            'thumbnail' => ''
        ];
    }
