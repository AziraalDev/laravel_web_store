...
function getFields() {
    return $(selectors.form).serializeArray()
        .reduce((obj, item) => {  //collapse array to Object
...
paypal.Buttons({
    ...
    createOrder: function(data, actions) {
        ...
        return axios.post('/ajax/paypal/order', getFields())
            // Important not to add '/' after the end of the route
            // it helps Laravel to work without error
            .then(function(res) {
